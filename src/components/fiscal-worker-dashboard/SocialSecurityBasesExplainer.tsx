      ...
      <div className="ssbe-shell">
        <header className="ssbe-header">
          <div className="ssbe-title-group">
            ...
            <div>
              <h1 id="ssbe-title">Bases mínimas y máximas de cotización</h1>
              <p>Edita tus datos y verás qué base se usa para cotizar.</p>
            </div>
            <span className="ssbe-badge">Régimen General 2025</span>
          </div>
          <nav className="ssbe-tabs" aria-label="Secciones">
            <button type="button" className="is-active"><Info size={18} />Explicación</button>
        ...
        <div className="ssbe-grid">
          <aside className="ssbe-card ssbe-inputs" aria-labelledby="ssbe-inputs-title">
            ...
            <FieldShell label="Año" icon={<Database size={17} aria-hidden="true" />}>
              <select value="2025" aria-label="Año" onChange={() => undefined}>
                <option>2025</option>
              </select>
            </FieldShell>
            ...
            <div className="ssbe-segmented-field">
              <span>Número de pagas</span>
              <div className="ssbe-segmented" role="group" aria-label="Número de pagas">
            ...
            <div className="ssbe-scenario-chips" aria-label="Escenarios">
              <button type="button" className="is-active"><CheckCircle2 size={14} />Caso mínimo</button>
              <button type="button">Caso normal</button>
              <button type="button">Caso máximo</button>
            </div>
          </aside>
          ...
          <section className="ssbe-card ssbe-calculation" aria-labelledby="ssbe-calc-title">
            <div className="ssbe-card-title">
              ...
              <h2 id="ssbe-calc-title">Cómo se calcula</h2>
            </div>

            <div className="ssbe-steps" aria-label="Flujo de cálculo">
              ...
              <article className="ssbe-step ssbe-step--purple">
                <h3><StepNumber value={2} tone="purple" />Compárala con los límites</h3>
                <div className="ssbe-limit-chips">
                  <span>Base mínima grupo 1: {formatEuro(minBase)}</span>
                  <span>Base máxima: {formatEuro(maxBase)}</span>
                </div>
              </article>
              <ArrowRight className="ssbe-step-arrow" size={28} aria-hidden="true" />
              <article className="ssbe-step ssbe-step--blue">
                <h3><StepNumber value={3} tone="blue" />Obtén la base final</h3>
                <strong>Base de cotización: {formatEuro(finalBase)}</strong>
              </article>
            </div>

            <div className="ssbe-range" aria-label="Comparación de bases entre cero y seis mil euros">
            ...
            <div className="ssbe-mini-flow" aria-label="Efecto posterior de la base usada">
              ...
              <span><ShieldCheck size={30} />Cotización SS</span>
              <ArrowRight size={24} aria-hidden="true" />
          ...
          <aside className="ssbe-results" aria-label="Resultado en tiempo real">
            <section className="ssbe-card ssbe-result-card">
              ...
              <div className="ssbe-result-top">
                <dl>
                  ...
                  <div><dt>Base mínima grupo 1</dt><dd>{formatEuro(minBase)}</dd></div>
                  <div><dt>Base máxima</dt><dd>{formatEuro(maxBase)}</dd></div>
                </dl>
                <div className="ssbe-final-base">
                  <span>Base de cotización final</span>
                  <strong>{formatEuro(finalBase)}</strong>
                  <em><CheckCircle2 size={17} />Se aplica el mínimo</em>
                </div>
              </div>
            ...
            <section className="ssbe-card ssbe-social-card">
              <div className="ssbe-card-title">
                ...
                <h2>Cotización social mensual</h2>
              </div>
              ...
              <p className="ssbe-total">Total cotización social: {formatEuro(totalContribution)} al mes</p>
              <p className="ssbe-note">
                <Info size={18} aria-hidden="true" />
                Aproximación mensual para contrato indefinido en Régimen General 2025. AT/EP no incluidas; depende de la actividad de la empresa.
              </p>
            </section>
          </aside>
          ...
          <section className="ssbe-card ssbe-examples" aria-labelledby="ssbe-examples-title">
            <div className="ssbe-card-title">
              ...
              <h2 id="ssbe-examples-title">Ejemplos rápidos</h2>
            </div>
            <div className="ssbe-example-row">
              <QuickExample tone="orange" label="Base máxima" before="6.000 €" after="4.909,50 €" text="Se aplica el máximo" />
              <QuickExample tone="purple" label="Base mínima grupo 1" before="1.700 €" after="1.929,00 €" text="Se aplica el mínimo" />
        ...
        <section className="ssbe-card ssbe-explanation" aria-labelledby="ssbe-explanation-title">
          <div className="ssbe-explanation-header">
            ...
            <h2 id="ssbe-explanation-title">Cómo afecta a tus impuestos y a tu nómina</h2>
            <span>Resumen práctico</span>
          </div>
          <div className="ssbe-explanation-grid">
            <ExplanationBlock
              tone="green"
              number={1}
              title="Si actúa la base mínima"
              icon={<Coins size={28} />}
              items={[
                'La base usada para cotizar sube al mínimo del grupo.',
                'Pagas más Seguridad Social que con tu base real.',
            ...
            <ExplanationBlock
              tone="blue"
              number={2}
              title="Si estás dentro del rango"
              icon={<Activity size={28} />}
              items={[
                'Se usa tu base real.',
                'No hay ajuste por mínimos ni máximos.',
                'La cotización y el IRPF siguen el comportamiento normal de tu salario.',
              ]}
            />
            <ExplanationBlock
              tone="orange"
              number={3}
              title="Si actúa la base máxima"
              icon={<Coins size={28} />}
              items={[
                'La base usada para cotizar se limita al tope máximo.',
                'La cotización social deja de subir al mismo ritmo.',
            ...
            <article className="ssbe-key">
              ...
              <h3>La idea clave</h3>
              <p><CheckCircle2 size={18} />Base mínima y máxima afectan sobre todo a la cotización social.</p>
              <p><CheckCircle2 size={18} />El IRPF se ve afectado de forma indirecta, no por el límite en sí.</p>
            </article>
          </div>
        </section>
      </div>
