...
import { BellRing, ChevronDown, ChevronUp, Lock, ShieldCheck, Smartphone, UserPlus } from 'lucide-react'
    ...
    <section className={`wpn${open ? ' is-open' : ''}`} aria-labelledby="wpn-title">
      <div className="wpn-head">
        ...
        <div className="wpn-headline">
          ...
          <p>
            No recogemos ningún dato sobre tu situación económica sin tu permiso. Aplicamos los estándares más altos de
            seguridad y privacidad: el cálculo se hace entero en tu dispositivo.
          </p>
        </div>
        ...
        <ul className="wpn-points">
          <li>
            ...
            <div>
              ...
              <p>
                Si recargas la página verás lo que ya habías puesto, porque queda guardado dentro de tu navegador. Si
                cambias de navegador o de dispositivo, no lo verás: esos datos no viajan contigo.
              </p>
            </div>
          </li>
          <li>
            ...
            <div>
              ...
              <p>
                Podrás crear una cuenta para llevarte tus datos de un dispositivo a otro. Aunque te hagas la cuenta,
                nosotros no tendremos acceso a ellos.
              </p>
            </div>
          </li>
          <li>
            ...
            <div>
              ...
              <p>
                Con cuenta podrás activar avisos cuando publiquemos algo nuevo: por ejemplo, cómo funcionan las
                pensiones en España y si son sostenibles, o un informe sobre si hoy cuesta más acceder a una vivienda
                que en el pasado.
              </p>
            </div>
          </li>
          <li>
            ...
            <div>
              ...
              <p>
                Justo debajo puedes cedernos tus cifras para estadísticas, siempre de forma anónima y siempre
                voluntaria. Si no dices nada, no se envía nada.
              </p>
            </div>
          </li>
        </ul>
    ...
    <section className={`wsc wsc--${consent}`} aria-labelledby="wsc-title">
      <div className="wsc-main">
        ...
        <p className="wsc-body">
          El cálculo funciona igual digas lo que digas, y puedes cambiar de opinión cuando quieras. Si aceptas,
          enviaremos las cifras que vayas poniendo en este recorrido <strong>sin nada que te identifique</strong>, solo
          para publicar estadísticas agregadas: cuánto se va en impuestos según el salario, cuánto pesa el IVA en cada
          nivel de renta o qué comunidades salen mejor paradas. Te lo agradeceríamos mucho.
        </p>
