...
- Si se quiere recuperar barras por categorias sanitarias, localizar una fuente oficial/institucional con cruce categoria x edad x sexo. Hasta entonces, el dashboard debe mantener `Total sanidad` y explicar la limitacion.
- Si se quiere replicar visualmente el panel de gasto sanitario con barras apiladas por categoria, localizar una tabla oficial/institucional que cruce categoria sanitaria, edad y sexo. El Excel AIReF 2025 permite total sanidad por edad/sexo y algunas piezas parciales de farmacia, pero no el desglose completo por categorias del mockup.
