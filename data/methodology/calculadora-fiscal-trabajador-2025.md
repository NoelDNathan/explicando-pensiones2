...
Desde 2026-07-17, el calculo anual 2025 usa un nucleo compartido y auditable para los pasos 4 y 5. El orden implementado es: rendimiento integro del trabajo; gastos del articulo 19 anteriores a `19.2.f`; otros gastos del articulo `19.2.f`; reduccion por obtencion de rendimientos del trabajo; reduccion general conjunta por prevision social con limite de 1.500 EUR y 30 %; escalas estatal y autonomica; minimos; y deduccion estatal 2025 por rendimientos del trabajo inferiores a 18.276 EUR. La deduccion queda limitada por la cuota atribuible a esos rendimientos.

Los ajustes cuyo calculo exige datos que la interfaz todavia no recoge —entre otros, incrementos de previs social de empleo, pension compensatoria, anualidades por alimentos, tributacion conjunta, patrimonios protegidos, cuotas sindicales/colegiales, maternidad, guarderia, familia numerosa, discapacidad a cargo, donativos, vivienda, empresas nuevas y deducciones autonomicas— se etiquetan como pendientes y no minoran automaticamente la base ni la cuota. Esta decision evita presentar una seleccion incompleta como resultado fiscal definitivo.

La regresion numerica del nucleo se ejecuta con `pnpm run verify:irpf2025`. Incluye salarios de 16.576, 18.000, 20.000 y 35.000 EUR, los limites de la nueva deduccion, el tope general de previs social y el umbral de 6.500 EUR de otras rentas. Los resultados completos con situaciones personales avanzadas siguen pendientes de contraste con Renta WEB 2025.
