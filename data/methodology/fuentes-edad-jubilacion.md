...
2. Congreso de los Diputados / Pacto de Toledo, Informe de evaluacion y reforma del Pacto de Toledo 2011.
   - Uso: serie total sistema 2004-2005, aunque el informe tambien publica 2006-2010.
   - Estado: descargado en bruto local.
   - Archivo: `data/raw/seguridad-social/edad-jubilacion/2026-05-27_pacto-toledo_informe-evaluacion-2011_edad-media-jubilacion_2004-2010.pdf`.

3. Ministerio de Trabajo e Inmigracion, `Extension de la vida laboral o insercion temprana de jovenes`.
   - Uso: proxy historica 1980-2003 basada en MCVL 2005.
   - Estado: descargado en bruto local.
   - Archivo: `data/raw/seguridad-social/edad-jubilacion/2026-05-27_ministerio-trabajo_insercion-temprana-jovenes_mcvl-edad-jubilacion-rg_1980-2004.pdf`.
   - Cautela: mide beneficiarios del Regimen General reconstruidos con microdatos MCVL, no total sistema. No debe dibujarse como el mismo tramo que 2004-2026 sin diferenciacion.

4. Seguridad Social, EVOMOD202501, `Evolucion de las altas iniciales de jubilacion por modalidades`.
...
5. Seguridad Social, catalogo `Edad de jubilacion en el acceso a la prestacion`, CSV `Evolucion de altas iniciales de jubilacion por edades`.
...
6. Ministerio de Empleo y Seguridad Social, nota de prensa de 2014 sobre edad real de jubilacion.
...
7. BOE / Seguridad Social, normativa de edad ordinaria.
...
Queda pendiente localizar una fuente oficial comparable para 1975-1979. Candidatas: anuarios estadisticos de Seguridad Social/MTAS, informes economico-financieros de presupuestos anteriores, Boletines de Estadisticas Laborales o reconstruccion desde tablas oficiales de altas por edad si publican distribucion completa. Para 1980-2003 ya existe proxy institucional MCVL de Regimen General; para 2004-2026 hay total sistema.
